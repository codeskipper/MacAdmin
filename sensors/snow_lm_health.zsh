...
#
# How:
# - check if the Snow Licence Manager Launch Daemon is installed
# - check if the Launch daemon is enbled
# Snow license manager creates and updates the following folder/file after installing when run regularly
# We'll check if the path exists and if not, return "No log file"
# If it exists, we'll check the content for the key "Last run", and if it doesn't exist, return "No Last Run date"
